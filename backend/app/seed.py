...
def seed_database(session: Session) -> None:
    ...
    setlogs = [
        ...
        Setlog(id="s_02", user_id="u_04", media_type=MediaType.video, media_url="/uploads/seed/IMG_9563.mp4", thumbnail_url="/uploads/seed/IMG_9563.jpg", caption="퇴근하고 토끼옷 입고 방에서 춤추는 중ㅋㅋ", category="chat", visibility="public", city_label="성수", hour_slot="20:00", created_at=BASE_TIME - timedelta(minutes=57), moderation_status=ModerationStatus.approved, like_count=8),
